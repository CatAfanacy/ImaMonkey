...
public class Client {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Departament department=new Departament("IT",employeeList);
            XDM.add(department);

            Employee testEmployee = new Employee("Kirill", "Medved",new Date(1973,03,8),7520,JobTitle.head);
            XDM.setJobTitle(testEmployee, JobTitle.engineer);
            XDM.setSalary(testEmployee,35000);

            Employee fireEmployee = new Employee("Kirill","Armeitsev", new Date(20171025),12341, JobTitle.assistant );
